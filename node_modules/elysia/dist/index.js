...
`));
  ...
  on(optionsOrType, typeOrHandlers, handlers) {
    ...
    for (const handle of handles) {
      ...
      switch ((this.config.name || this.config.seed) && (fn.checksum = (0, import_utils2.checksum)(
  ...
  guard(hook, run) {
    ...
    if (this.singleton = (0, import_utils.mergeDeep)(this.singleton, instance.singleton), this.definitions = (0, import_utils.mergeDeep)(this.definitions, instance.definitions), sandbox.getServer = () => this.server, sandbox.event.request?.length && (this.event.request = [
      ...this.event.request || [],
      ...sandbox.event.request || []
    ]), sandbox.event.mapResponse?.length && (this.event.mapResponse = [
      ...this.event.mapResponse || [],
  ...
  mount(path, handleOrConfig, config) {
    if (path instanceof _Elysia || typeof path == "function" || path.length === 0 || path === "/") {
      ...
      })(), handler2 = ({ request, path: path2 }) => run(new Request((0, import_utils2.replaceUrlPath)(request.url, path2), request));
